...
Download [the latest AAR](https://repo1.maven.org/maven2/com/jaredrummler/android-device-names/1.1.7/android-device-names-1.1.7.aar) or grab via Gradle:
